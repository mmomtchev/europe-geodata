...
| `admin.min.geojson` | All European national and regional borders with Norway and Finland slightly simplified to reduce file size | Extracted from OSM |  Open Data Commons Open Database License (ODbL)
